...
public class LastDigitChecker {
    public static void main(String[] args) {
        System.out.println(hasSameLastDigit(345,765,988));
        System.out.println(hasSameLastDigit(345,765,985));
        System.out.println(hasSameLastDigit(345,766,988));
        System.out.println(hasSameLastDigit(5,765,988));
        System.out.println(hasSameLastDigit(345,765,1988));

        System.out.println(isValid(10));
        System.out.println(isValid(468));
        System.out.println(isValid(1986));
    ...
    public static boolean hasSameLastDigit(int number1, int number2, int number3) {
        ...
        while (number1 > 10 || number1 > 1000 || number2 > 10 || number2 > 1000 || number3 > 10 || number3 > 1000){
            int lastDigitNumber1 = 0;
            int lastDigitNumber2 = 0;
            int lastDigitNumber3 = 0;
