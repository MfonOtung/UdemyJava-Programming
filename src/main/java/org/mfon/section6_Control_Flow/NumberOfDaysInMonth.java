...
public class NumberOfDaysInMonth {
    ...
    /**
     ...
     getDaysInMonth(2, 2018); → should return 28 since
     February has 28 days if it's not a leap year and 2018 is not a leap year.
    ...
    public static int getDaysInMonth(int month, int year) {
        int numberOfDays1 = 31;
        int numberOfDays2 = 30;
        int numberOfDays3 = 28;
        if (month <1 || month > 12 || year < 1 || year > 9999){return -1;};
        //int invalidMonthOrYear = -1;
        int monthOfYear = month;
        if (isLeapYear(year)){numberOfDays3 = 29;};
        return switch (month){
            case 1 -> numberOfDays1;
            case 2 -> numberOfDays3;
            case 3 -> numberOfDays1;
            case 4 -> numberOfDays2;
            case 5 -> numberOfDays1;
            case 6 -> numberOfDays2;
            case 7 -> numberOfDays1;
            case 8 -> numberOfDays1;
            case 9 -> numberOfDays2;
            case 10 -> numberOfDays1;
            case 11 -> numberOfDays2;
            case 12 -> numberOfDays1;
            default -> {
                yield -1;
            }
        };
