package org.mfon.section13_NestedClasses_And_Types.Playlist_Coding_Challenge;
...
/**
 ...
 The Album class will be modified to use an inner class called SongList which will replace the ArrayList that was used
 to hold the list of songs for an album.
 The SongList inner class will use an ArrayList to hold the track list for the album. To do this a member variable
