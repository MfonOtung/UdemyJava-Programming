...
/**
 ...
 -  addNewContact(), has one parameter of type Contact and returns a boolean. Returns true if the contact doesn't exist,
    or false if the contact already exists.
 -  updateContact(), has 2 parameters of type Contact (the old contact that'll be updated with the new contact) and
    returns a boolean. Returns true if d contact exists & was updated successfully, or false if d contact doesn't exist.
 ...
 -  findContact(), has one parameter of type Contact and returns an int. The returned value is its position in the
